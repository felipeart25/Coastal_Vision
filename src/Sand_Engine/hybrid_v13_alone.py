...
class ProgressiveWaveContextEncoder(nn.Module):
    ...
    def forward(self, wave_input, wave_future):
        ...
        print(self.future_seq)
        print(self.wave_steps_per_frame)
        contexts = []
        c=0
...
class Predictor(nn.Module):
    ...
    def forward(self, slow_input, fast_input, fast_fut_input, future_seq=1, inference=False):
        ...
        print("wave_context shape:", wave_context.shape)
        ...
        for t in range(future_seq):
            ...
            print("wave_idx:", wave_idx)
            print("wave_context shape:", wave_context.shape)
            print("wavecontext size:", wave_context.size(1))
...
def main():
    ...
    wandb.init(project="THESIS",
        name=f"hybrid_v13_30Epochs_case1_weekly",
        config={
        "input_dim": 1,
        "hidden_dims": [ 64, 64],
